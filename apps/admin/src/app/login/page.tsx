        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full p-12 text-white">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold font-['Poppins',sans-serif]">ServEase</h1>
          ...
          <div className="text-center max-w-md">
            <h2 className="text-4xl font-bold mb-4 font-['Poppins',sans-serif]">Connect. Work. Earn.</h2>
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-gray-50">
        <div className="w-full max-w-[460px]">
          ...
          <div className="lg:hidden mb-8 text-center">
            <div className="inline-flex items-center gap-3 mb-2">
              ...
              <div className="text-left">
                <h1 className="text-2xl font-bold text-gray-900 font-['Poppins',sans-serif]">ServEase</h1>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
            ...
            <div className="mb-6">
              <h2 className="text-2xl font-bold text-gray-900 font-['Poppins',sans-serif]">Sign in</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={error ? "border-red-500 rounded-xl" : "rounded-xl"}
                  required
                  autoFocus
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className={`pr-10 rounded-xl ${error ? "border-red-500" : ""}`}
                    required
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-between">
                ...
                <Link
                  ...
                  className="text-sm text-[#00BF63] hover:text-[#00A055] font-semibold"
                >
                  Forgot password?
                </Link>
              </div>
              ...
              <Button
                type="submit"
                className="w-full bg-[#00BF63] hover:bg-[#00A055] h-12 rounded-xl text-white font-semibold transition-all shadow-md hover:shadow-lg"
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
              ...
              <p className="text-center text-sm text-gray-600 pt-2">
                ...
                <button
                  ...
                  className="text-[#00BF63] hover:text-[#00A055] font-semibold hover:underline"
                >
